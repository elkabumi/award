                                ...
                                <div class="col-md-12">
                                        ...
                                        <table id="" width="100%"  cellpadding="5">
                                          ...
                                          <td width="3%" valign="top" align="center"><strong><?= $no_question."."; ?></strong></td>
                                            <td  colspan="2"width="97%"><b> <?= $r_question['qp2_name'] ?></b></td>
                                          ...
                                          <tr>
                                         	 <td>&nbsp;</td>
                                          	 <td>Input NIlai</td>
                                         	 <td> <input required="required" type="number" name="i_answer_pma2_<?= $no_question ?>_<?=$r_question['qp2_cat_pma_id']?>_<?=$r_question['qp2_type']?>_<?=$r_question['qp2_id']?>"class="form-control" placeholder="" value=""/>
                                        	 </td>
                   					 </tr>
                                    </table>

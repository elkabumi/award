    ...
    <body class="skin-blue">
        ...
        <header class="header">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="14%"><img src="../img/jatim.png" width="30" style="margin-right:10px;"></td>
                <td width="86%"><span style="font-size:11px; font-weight:bold; color:#0FF">BADAN PENANAMAN MODAL </span><br><span style="font-weight:bold;">JAWA TIMUR</span></td>
              </tr>
            </table>

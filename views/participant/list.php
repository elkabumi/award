                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <div class="title_page">DATA PESERTA KABUPATEN/ KOTA</div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body no-padding">
                                     ...
                                     <a href="participant.php?page=form&id=<?= $row['participant_id']?>" class="btn btn-danger" ><i class="fa fa-pencil"></i></a>

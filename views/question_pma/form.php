                            ...
                            <div class="box box-cokelat">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input required type="text" name="i_name" class="form-control" placeholder="Enter name ..." value="<?= $row->qp1_name ?>"/>
                                        </div>
                                       
                                       	<div class="form-group"> 
                                                          
                                        <label>
                                            <input type="radio" name="i_get_child" class="minimal" value="1" <?php if($row->qp1_get_child == 1){ ?>checked <?php } ?> />
                                        </label>
